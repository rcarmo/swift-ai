...
| 131 | `packages/ai/test/xai-responses.test.ts` | ported | `testGrok45ResponsesCatalogAndActualRequestMatrix`, `testUpstream0843XAI46EncryptedReasoningAndUA` | xAI built-in migration to Responses, encrypted reasoning replay, Grok 4.6/default endpoint/reasoning/UA, and actual transport wire assertions. |
