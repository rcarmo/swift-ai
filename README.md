...
This package is a SwiftPM library port prepared for consumption by Swift applications and services. It tracks upstream `@earendil-works/pi-ai` **0.80.10**. See `STATUS.json` for machine-readable parity/transport status, or `SwiftAIStatus` at runtime.
...
- Full embedded text model catalog generated from audited upstream `pi-ai` v0.80.10: 1072 models / 35 providers.
