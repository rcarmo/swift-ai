...
v0.80.3 counts, that every generated API/provider raw value is represented in
...
TEXT_MODELS = ROOT / "scripts" / "models.v0.80.3.json"
IMAGE_MODELS = ROOT / "scripts" / "image-models.v0.80.3.json"
