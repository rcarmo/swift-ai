...
Tracks upstream `@earendil-works/pi-ai` **v0.87.0** via direct upstream inspection (release tag `16787ad5b2dc748047f314ca1bfe7708f30f54f3`). `STATUS.json` contains the same high-level status in machine-readable form.
...
- Full embedded text model registry generated from exact upstream `pi-ai` v0.87.0 tag `16787ad`: **1445 models / 41 providers / 10 APIs**, with an upstream-source comparator gate.
- Full embedded image model registry generated from exact upstream `pi-ai` v0.87.0 tag `16787ad`: **54 models / 1 provider**.
...
## v0.87.0 release audit

See `docs/upstream-v0.87.0-audit.md` for the exact 127-path cumulative disposition matrix from accepted v0.85.1 `d981de1229ef899957bbe968bc8dcda02a21f477` through release tag `16787ad5b2dc748047f314ca1bfe7708f30f54f3`.

## v0.85.1 release audit

See `docs/upstream-v0.85.1-audit.md` for the exact 9-path disposition matrix from accepted v0.85.0 `107d79f11072bbc8a3a757ed7fd69596bee7d68c` through release tag `d981de1229ef899957bbe968bc8dcda02a21f477`.

## v0.85.0 release audit

See `docs/upstream-v0.85.0-audit.md` for the exact 51-path disposition matrix from accepted v0.84.4 `b79e4cc834970cca69daebffab7df1da7d1e52c4` through release tag `107d79f11072bbc8a3a757ed7fd69596bee7d68c`.

## v0.84.4 release audit

See `docs/upstream-v0.84.4-audit.md` for the exact 15-path disposition matrix from accepted v0.84.3 `4e58f324fae8ebfa98a3d45181fb248072a2afac` through release tag `b79e4cc834970cca69daebffab7df1da7d1e52c4`.

## v0.84.3 release audit

See `docs/upstream-v0.84.3-audit.md` for the exact 48-path disposition matrix from accepted v0.84.2 `914cf1472e715297caa30db4b9535d534a9eb718` through release tag `4e58f324fae8ebfa98a3d45181fb248072a2afac`.

## v0.84.2 release audit

See `docs/upstream-v0.84.2-audit.md` for the exact 42-path disposition matrix from accepted v0.84.1 `53fa77ccd8a279eb87e92294ef3687b03ff80112` through release tag `914cf1472e715297caa30db4b9535d534a9eb718`.
...
See `docs/upstream-v0.84.0-audit.md` for the exact 101-path disposition matrix from v0.83.0 `845d6ff1f6643aba440341cce877ce1c43ebbc39` through release tag `a5f43bf8aff3c55752432655f7334e3dafd1e256`.
...
Local validation uses Swift 6.3.2 in this workspace; use:

```bash
make test
```

The toolchain-light static validation gate is:
