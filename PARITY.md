...
Tracks upstream `@earendil-works/pi-ai` **v0.85.1** via direct upstream inspection (release tag `d981de1229ef899957bbe968bc8dcda02a21f477`). `STATUS.json` contains the same high-level status in machine-readable form.
...
- Full embedded text model registry generated from exact upstream `pi-ai` v0.85.1 tag `d981de1`: **1354 models / 39 providers / 9 APIs**, with an upstream-source comparator gate.
- Full embedded image model registry generated from exact upstream `pi-ai` v0.85.1 tag `d981de1`: **52 models / 1 provider**.
