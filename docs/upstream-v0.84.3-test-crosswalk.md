...
| 47 | `packages/ai/test/github-copilot-oauth.test.ts` | ported | Copilot OAuth/concurrency tests | Throttle/retry/policy/login budget/persistence fixes represented by structured concurrency/cancellation tests. |
