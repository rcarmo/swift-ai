...
Tracks upstream `@earendil-works/pi-ai` **v0.82.1** via direct upstream inspection (release tag `b4f293684bba718d59cc1157679bcf6157b3a7f5`). `STATUS.json` contains the same high-level status in machine-readable form.
...
- Full embedded text model registry generated from exact upstream `pi-ai` v0.82.1 tag `b4f2936`: **1109 models / 37 providers**, with an upstream-source comparator gate.
- Full embedded image model registry generated from upstream `pi-ai` v0.82.1: **40 models / 1 provider**.
...
## v0.82.1 release audit

See `docs/upstream-v0.82.1-audit.md` for the exact 23-path disposition matrix from v0.82.0 `083e61621276bff9f6faefab87ce07fcd98734e2` through release tag `b4f293684bba718d59cc1157679bcf6157b3a7f5`.
